...
if (isset($_POST['save'])) {
  ...
  $sql = "INSERT INTO `churches` (`church_LocalName`, `church_Street`, `church_Barangay`, `church_Town`, `church_Province`, `church_ZipCode`, `church_LocalPastor`, `church_ContactNumber`)
          VALUES ('$form_ChurchName', '$form_Street', '$form_Barangay', '$form_Town', '$form_Province', '$form_ZipCode' , '$form_LocalPastor' , '$form_ContactNumber');";
